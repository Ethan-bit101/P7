...
interface JwtPayload {
  ...
  return (
    ...
    <figure className = "inline-block">
      ...
      <Image src="/chest_pain.jpg" alt="Homepage" width={120} height={120} className="inline-block" />
      <figcaption className='inline-block'>Malcom Todd- Chest Pain</figcaption></Link>
    </figure>
    </div>
